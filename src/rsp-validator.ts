...
//     const fmts = args.customFormats;
//     if (fmts) {
//       Object.keys(fmts).forEach((format) => {
//         const func = fmts[format];
...
//     const extLists = args.externalSchemas;
//     if (extLists) {
//       Object.keys(extLists).forEach((id) => {
//         v.addSchema(extLists[id], id);
//       });
//     }
...
//   public validateResponse(statusCode: string, response: any) {
//     let validator;
